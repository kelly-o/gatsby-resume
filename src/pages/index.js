...
let GoJekExperience = {
  ...
  bullets: [
    ...
    "Built an app from start to finish in the video streaming space. Currently in public beta. Uses [Rome](https://github.com/blender/Rome/) to point to remote instances of [minio](minio.io) to cache dependencies and reduce build times to ~7 minutes (a **90%** decrease).",
...
let publicStuffSection = { title: "Conference talks & articles", bullets: publicAppearancesAndWriting }
